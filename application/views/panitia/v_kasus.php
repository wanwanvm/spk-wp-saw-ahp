  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          DATABASE
          <small></small>DAFTAR KASUS
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li class="active">DAFTAR KASUS</li>
        </ol>
      </section>
            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <a href="<?php echo base_url() ?>panitia/tambahkasus"> + Tambah Data</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <table border="1" cellpadding="1" cellspacing="1" bordercolor="#000000" class="table table-striped" id="example1" style="font-size:12px;">
                      <thead>
                        ...
                        <tr>
                          ...
                          <th width="32">Nama Kasus</th>
                          <th width="80">Tanggal Kasus</th>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $tgl_kasus; ?></td>
                            <td>|<a href="<?php echo base_url() ?>panitia/kasus/hapus_kasus?id_kasus=<?php echo $id_kasus; ?>" class="style1" onclick="return confirm('Anda Yakin Akan Menghapus?')">Hapus</a>|</td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
                    </table>
