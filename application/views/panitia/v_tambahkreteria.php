...
<head>
  ...
  <title>SAPA-PROPOSAL | Data Peserta</title>
...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Data Link Tayang</li>
        </ol>
      </section>

      <!-- Main content -->
      <section class="content">
        <form action="<?php echo base_url() . 'panitia/tambahkreteria/simpan_data' ?>" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colspan="3" align="center">
                            <h5 align="center"><strong>TAMBAH KRETERIA</strong></h5>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td>Kode Kreteria </td>
                          <td>:</td>
                          <td> <span class="style1"><input class="form-control" name="kd_kreteria" type="text" id="kd_kreteria" required></span></td>
                        </tr>
                        <tr>
                          <td>Nama Kreteria </td>
                          <td>:</td>
                          <td> <span class="style1"><input class="form-control" name="nm_kreteria" type="text" id="nm_kreteria" required></span></td>
                        </tr>
                        <tr>
                          <td>Bobot </td>
                          <td>:</td>
                          <td> <span class="style1"><input class="form-control" name="bobot" type="text" id="bobot" required></span></td>
                        </tr>
                        <tr>
                          <td><span class="style1">Jenis cost/Benefit </span></td>
                          <td> : </td>
                          <td> <select name="jns_kreteria" id="jns_kreteria" class="form-control" required>
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td><label></label>
                            <input class="btn btn-danger" type="submit" name="Submit" value="Tambah Kreteria + ">
                            <label> [ <a href="<?php echo base_url() ?>panitia/kreteria" class="style1">Kembali </a> ] </label>
                          </td>
                        </tr>
  ...
  <?php elseif ($this->session->flashdata('msg') == 'warning') : ?>
    <script type="text/javascript">
      $.toast({
        heading: 'Warning',
        text: "Gambar yang Anda masukan terlalu besar/Tidak ada gambar yang di masukan/Tipe file salah.",
        showHideTransition: 'slide',
        icon: 'warning',
        hideAfter: false,
        position: 'bottom-right',
