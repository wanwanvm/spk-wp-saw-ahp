  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          DATABASE
          <small></small>DAFTAR KRETERIA
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li class="active">DAFTAR KRETERIA</li>
        </ol>
      </section>
            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <a href="<?php echo base_url() ?>panitia/tambahkreteria"> + Tambah Data</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>|<a href="<?php echo base_url() ?>panitia/kreteria/hapus_kreteria?id_kreteria=<?php echo $id_kreteria; ?>" class="style1" onclick="return confirm('Anda Yakin Akan Menghapus?')">Hapus</a>|</td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
                    </table>
