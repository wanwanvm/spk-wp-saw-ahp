  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <form action="<?php echo base_url() . 'panitia/tambahkasus/simpan_data' ?>" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colspan="3" align="center">
                            <h5 align="center"><strong>Tambah Kasus</strong></h5>
                          </td>
                        </tr>
                        <tr>
                          <td>&nbsp;Nama Kasus </td>
                          <td>:</td>
                          <td> <span class="style1"><input class="form-control" name="nm_kasus" type="text" id="nm_kasus" required></span></td>
                        </tr>
                        <tr>
                          <td>&nbsp; </td>
                          <td></td>
                        ...
                        <tr>
                          ...
                          <td><label></label>
                            <input class="btn btn-danger" type="submit" name="Submit" value="Tambah Kasus + ">
                            <label> [ <a href="<?php echo base_url() ?>panitia/kasus" class="style1">Kembali </a> ] </label>
                          </td>
                        </tr>
