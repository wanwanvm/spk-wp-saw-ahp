  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <form action="<?php echo base_url() . 'panitia/tambahatribut/simpan_data' ?>" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colspan="3" align="center">
                            <h5 align="center"><strong>TAMBAH ATRIBUT</strong></h5>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td>Satuan </td>
                          <td>:</td>
                          <td> <span class="style1"><input class="form-control" name="satuan" type="text" id="satuan" required></span></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td><label></label>
                            <input class="btn btn-danger" type="submit" name="Submit" value="Tambah atribut + ">
                            <label> [ <a href="<?php echo base_url() ?>panitia/atribut" class="style1">Kembali </a> ] </label>
                          </td>
                        </tr>
