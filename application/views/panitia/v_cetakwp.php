  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          DATABASE
          <small></small>PERHITUNGAN DENGAN METODE (WP)
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li class="active">Metode WP</li>
        </ol>
      </section>
                    ...
                    <table border="1" cellpadding="1" cellspacing="1" bordercolor="#000000" class="table table-striped" id="example1" style="font-size:12px;">
                      <thead>
                        ...
                        <tr>
                          ...
                          <th width="80">WJ</th>
                          <th width="80">WJ Ternormalisasi</th>
                        </tr>
                      </thead>
                      <tbody>
                        <?php
                        // $id_atribut = $i['id_atribut'];
                        $hapusisibobot = $this->db->query("TRUNCATE tb_normalisasikreteriawp");
                        //--------------------------------
                        $hasil = $totbobot->row();
                        ...
                        foreach ($data->result_array() as $i) :
                          ...
                          if ($jns_kreteria == 'benefit') {
                            ...
                            $wjnorbobot =  $norbobot * -1;
                          }

                          // $id_atribut = $c['id_atribut'];
                          $qqq = $this->db->query("REPLACE INTO tb_normalisasikreteriawp(id_kreteria,nilainorbobot,nilaiwjbobot) 
                          VALUES ('$id_kreteria','$norbobot','$wjnorbobot')");
                        ?>
                          <tr>
                            <td height="22">
      ...
      <?php
      // $id_atribut = $i['id_atribut'];
      $hapusisi = $this->db->query("TRUNCATE tb_normalisasi_atribut_wp");
      //--------------------------------
      $no = 0;
      foreach ($data_atribut->result_array() as $i) :
        $no++;
        ...
        //memasukan pembagi
        $q = $this->db->query("SELECT  tb_normalisasikreteriawp.nilaiwjbobot FROM tb_normalisasikreteriawp,tb_atribut 
                          WHERE tb_atribut.id_kreteria=tb_normalisasikreteriawp.id_kreteria  
                          and tb_atribut.id_kreteria='$id_kreteria'");
        $c = $q->row_array();
        //$pembagi = $c['pembagi'];
        // $id_kreteriax = $c['id_kreteria'];
        $nilaiwjbobot = $c['nilaiwjbobot'];
        ...
        $nilai = $i['nilai_atribut'];
        $satuan = $i['satuan'];
        $nilaiwjbobot2 = pow($nilai, $nilaiwjbobot);

        //$id_atribut = $c['id_atribut'];
        $qqqq = $this->db->query("REPLACE INTO tb_normalisasi_atribut_wp(id_alternatif,id_kreteria,id_atribut,nilaiwj) VALUES 
         ('$id_alternatif','$id_kreteria','$id_atribut','$nilaiwjbobot2')");
      ?>
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <b> TABEL NORMALISASI ATRIBUT Cn^Wj </b>
                </div>

                <!-- /.box-header -->
                <div class="box-body">
                  <div class="table-responsive">
                    <table border="1" cellpadding="1" cellspacing="1" b2ordercolor="#000000" class="table table-striped" id="example3" style="font-size:12px;">
                      ...
                      <tbody>
                        <?php
                        // $id_atribut = $i['id_atribut'];
                        // $hapusisiku = $this->db->query("TRUNCATE tb_si");
                        //--------------------------------
                        $hasilxx = 0;
                        $jumlahsi = 0;
                        $no = 0;
                        foreach ($data_atributwp->result_array() as $ixs) :
                          $no++;
                          $id_kasuss = $ixs['id_kasus'];
                          $nm_kasuss = $ixs['nm_kasus'];
                          $id_alternatifs = $ixs['id_alternatif'];
                          $nm_alternatifs = $ixs['nm_alternatif'];
                          $nm_kreterias = $ixs['nm_kreteria'];
                          $nilai_atributs = $ixs['nilai_atribut'];
                          $nilaiwjs = $ixs['nilaiwj'];
                          $nilaiwjbobot = $ixs['nilaiwjbobot'];
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo "$nm_kasuss"; ?></td>

                            <td><?php echo "$nm_alternatifs"; ?></td>
                            <td><?php echo "$nm_kreterias"; ?></td>
                            <td><?php echo "$nilai_atributs"; ?></td>
                            <td><?php echo "$nilaiwjbobot"; ?></td>
                            <td><?php echo "$nilaiwjs"; ?></td>
          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <div class="table-responsive">
                    <table border="1" cellpadding="1" cellspacing="1" b2ordercolor="#000000" class="table table-striped" id="example5" style="font-size:12px;">
                      ...
                      <tbody>
                        ...
                        $jumlahsi = 0;
                        $no = 0;
                        foreach ($data_alternatif->result_array() as $ix) :
                          $no++;
                          $id_kasus = $ix['id_kasus'];
                          $id_alternatif = $ix['id_alternatif'];
                          $nm_alternatif = $ix['nm_alternatif'];

                          //$jum_comment = $qx->num_rows();
                        ?>
                          ...
                          // $nm_alternatif = $cx['nm_alternatif'];
                          $holds = explode(',', $cx['nilaidata']);
                          $nilaiwjx = $cx['nilaiwj'];

                          $nilaia = (array_product($holds));


                          $qqqx = $this->db->query("REPLACE INTO tb_si(id_alternatif,nilaisi,id_kasus) 
                          VALUES ('$id_alternatif','$nilaia','$id_kasus')");
                          ?>
                          <tr>
                            <td height="22">
                              <div align="center"><?php echo $no; ?></div>
      ...
      <?php
      // $id_atribut = $i['id_atribut'];
      $hapusisikuf = $this->db->query("TRUNCATE tb_nilaiwp");
      //--------------------------------
      $qxx = $this->db->query("SELECT id_alternatif,SUM(nilaisi) as nilaisi FROM tb_si WHERE id_kasus='$id_kasus' ");
      // $menux = array();
      $cxx = $qxx->row_array();
      $totalsi = $cxx['nilaisi'];
      // echo "$totalsi<br>";
      foreach ($data_si->result_array() as $ix) :
        //$no++;
        $nilaisi = $ix['nilaisi'];
        $id_kasus = $ix['id_kasus'];
        $normsi = $nilaisi / $totalsi;
        $id_alternatif2 = $ix['id_alternatif'];
        // echo "$normsi<br>";
        $qqq1 = $this->db->query("REPLACE INTO tb_nilaiwp(id_kasus,nilai_wp,id_alternatif) VALUES 
         ('$id_kasus','$normsi','$id_alternatif2')");
                  ...
                  <div class="table-responsive">
                    <table border="1" cellpadding="1" cellspacing="1" bordercolor="#000000" class="table table-striped" id="example4" style="font-size:12px;">
                      ...
                      <tbody>
                        ...
                        $no = 0;
                        foreach ($data_hasilwp->result_array() as $aa) :
                          $no++;

                          $nilai_wp = $aa['nilai_wp'];
                          $nm_alternatif = $aa['nm_alternatif'];
                        ?>
                          <tr>
                            <td height="22">
                              <div align="center"><?php echo $no; ?></div>
