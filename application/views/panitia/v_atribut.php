  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          DATABASE
          <small></small>DAFTAR ATRIBUT
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
          <li class="active">DAFTAR ATRIBUT</li>
        </ol>
      </section>
            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <a href="<?php echo base_url() ?>panitia/tambahatribut"> + Tambah Data</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>|<a href="<?php echo base_url() ?>panitia/atribut/hapus_atribut?id_atribut=<?php echo $id_atribut; ?>" class="style1" onclick="return confirm('Anda Yakin Akan Menghapus?')">Hapus</a>|</td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
                    </table>
