  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <form action="<?php echo base_url() . 'panitia/tambahalternatif/simpan_data' ?>" method="post" enctype="multipart/form-data">
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td colspan="3" align="center">
                            <h5 align="center"><strong>TAMBAH ALTERNATIF <?php echo $this->session->userdata('id_kasus'); ?></strong></h5>
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td>Kode Alternatif ** Contoh : A1 </td>
                          <td>:</td>
                          <td> <span class="style1"><input class="form-control" name="kd_alternatif" type="text" id="kd_alternatif" required></span> </td>
                        </tr>
                        <tr>
                          <td>Nama Alternatif ** Contoh : CK-1 </td>
                          <td>:</td>
                          <td> <span class="style1"><input class="form-control" name="nm_alternatif" type="text" id="nm_alternatif" required></span> </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td>&nbsp;</td>
                          <td><label></label>
                            <input class="btn btn-danger" type="submit" name="Submit" value="Tambah Alternatif + ">
                            <label> [ <a href="<?php echo base_url() ?>panitia/alternatif" class="style1">Kembali </a> ] </label>
                          </td>
                        </tr>
