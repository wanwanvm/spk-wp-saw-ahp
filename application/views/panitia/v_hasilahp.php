            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <a href="<?php echo base_url() ?>panitia/tambahkasus"> + Tambah Data Kasus</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>|<a href="<?php echo base_url() . '' ?>ahp/index.php?id_kasus=<?php echo $id_kasus; ?>&id_panitia=<?php echo $op; ?>" class="style1">Hitung Model AHP</a>|</td>
                          </tr>
                        <?php endforeach; ?>
                      </tbody>
                    </table>
