...
session_start();
$_SESSION['id_panitia'] = $_GET['id_panitia'];
$_SESSION['id_kasus'] = $_GET['id_kasus'];

isset($_SESSION['id_panitia']);
isset($_SESSION['id_kasus']);
//session_start();
if (!isset($_SESSION['id_panitia'])) {
	header("Location:http://localhost/tugas-spk4");
}
