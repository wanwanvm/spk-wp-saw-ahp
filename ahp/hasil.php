...
<section class="content">
	...
	<table class="ui celled collapsing table">
		...
		<tbody>
			<?php
			$query  = "SELECT nm_alternatif,alternatif.id_alternatif,nilai FROM alternatif,ranking WHERE alternatif.id_alternatif = ranking.id_alternatif and alternatif.id_kasus='$id_kasus' ORDER BY nilai DESC";
			$result = mysqli_query($koneksi, $query);
